...
<div class="element-fields">
	...
	<?php echo $form->dropDownList($element, 'discharged_home_on_id', CHtml::listData(Element_OphCiDischargenote_Details_DischargedHomeOn::model()->findAll(array('order'=> 'display_order asc')),'id','name'),array('empty'=>'- Please select -'))?>
	<?php echo $form->radioBoolean($element, 'information_provided')?>
